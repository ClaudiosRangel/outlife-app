...
export type Database = {
  ...
  public: {
    Tables: {
      community_posts: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "public_user_locations"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      profiles: {
        Row: {
          ...
          location_sharing_mode: Database["public"]["Enums"]["location_sharing_mode"]
          location_updated_at: string | null
          longitude: number | null
          price: string | null
          profile_views: number
          progress_to_next_level: number | null
          rating: number | null
      ...
      user_activities: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_activities_destination_id_fkey"
            columns: ["destination_id"]
            isOneToOne: false
            referencedRelation: "destinations"
            referencedColumns: ["id"]
      ...
      user_checklists: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_checklists_destination_id_fkey"
            columns: ["destination_id"]
            isOneToOne: false
            referencedRelation: "destinations"
            referencedColumns: ["id"]
      ...
      public_user_locations: {
        Row: {
          ...
          location_sharing_mode:
            | Database["public"]["Enums"]["location_sharing_mode"]
            | null
          location_updated_at: string | null
          longitude: number | null
          username: string | null
    ...
    Enums: {
      app_role: "adventurer" | "partner"
      app_role_enum: "admin" | "moderator" | "user"
      destination_status: "pending" | "approved" | "rejected"
      location_sharing_mode: "none" | "friends" | "public"
      profile_status: "active" | "inactive" | "pending_verification"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
