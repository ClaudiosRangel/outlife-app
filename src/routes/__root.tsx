...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OutVitar — A vida não é só trilhar" },
      ...
      { property: "og:title", content: "OutVitar — A vida não é só trilhar" },
      ...
      { name: "twitter:title", content: "OutVitar — A vida não é só trilhar" },
