...
import { ArrowLeft, ShieldAlert, ShieldCheck, MapPin, ChevronRight, Lightbulb, LayoutDashboard, Type, Megaphone, MessageSquare, Dumbbell, Mountain } from "lucide-react";
...
function AdminHub() {
  ...
  const cards = [
    ...
    {
      to: "/admin/trilhas" as const,
      icon: Mountain,
      title: t("admin.trailsTitle", "Trilhas e destinos"),
      desc: t("admin.trailsDesc", "Liberar ou ocultar trilhas importadas (OSM/ICMBio)."),
      badge: 0,
    },
    {
      ...
      desc: t("admin.feedbackDesc", "Ver o que os usuários acharam do app."),
      badge: 0,
    },
    {
