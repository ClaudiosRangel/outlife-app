...
-- ############################################################################
-- 36) 20260922120000_segment-trophies.sql
--     Troféus de segmento do usuário (Conquistas). RPC SECURITY DEFINER
--     my_segment_trophies(_max_rank int default 10): para cada segmento em
--     que o usuário está no top _max_rank (1 = Rei/KOM), retorna posição,
--     melhor tempo, total de atletas e a activity_id do esforço campeão.
--     (idempotente)
-- ############################################################################
