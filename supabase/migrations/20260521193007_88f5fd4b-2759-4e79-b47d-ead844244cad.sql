...
-- ============ PROFILES ============
-- NOTE: We intentionally omit the FK to auth.users so demo partner seed rows
-- can exist without auth accounts. Real signups still get a profile via the
-- handle_new_user trigger using auth.users.id. The id column is still UUID PK.
...
-- ============ SEED: SAMPLE PARTNER PROFILES (demo data) ============
...
VALUES
  ...
  ('22222222-2222-2222-2222-222222222202', 'ventonorte', 'Pousada Vento Norte', '/src/assets/partner-lodge.jpg', 'partner', 'Bonito, MS', 4.8, 187, true, 'Pousada sustentável às margens do Rio Formoso. Café da manhã com produtos locais, trilhas particulares e observação de pássaros.', 'Pousadas', '+5567999992222', '@ventonorte', 'active'),
  ('22222222-2222-2222-2222-222222222203', 'caiolente', 'Caio Lente', '/src/assets/partner-photographer.jpg', 'partner', 'Chapada Diamantina, BA', 4.7, 96, false, 'Fotógrafo especializado em paisagens e astrofotografia na Chapada. Ensaios de aventura e cobertura de expedições.', 'Fotógrafos', '+5571999993333', '@caiolente', 'active'),
  ('22222222-2222-2222-2222-222222222204', 'trilhasdosol', 'Trilhas do Sol', '/src/assets/trilha_pedra_do_sino.jpg', 'partner', 'Campos do Jordão, SP', 4.6, 142, true, 'Roteiros de trekking leve a moderado nas montanhas paulistas. Ideal para iniciantes e famílias com crianças.', 'Guias', '+5512999994444', '@trilhasdosol', 'active'),
  ('22222222-2222-2222-2222-222222222205', 'ecolodgeserraverde', 'Eco Lodge Serra Verde', '/src/assets/partner-lodge.jpg', 'partner', 'Monte Verde, MG', 4.9, 310, true, 'Lodge de montanha com spa, sauna finlandesa e gastronomia orgânica. Quartos com lareira e vista para o vale.', 'Pousadas', '+5535999995555', '@ecolodgeserraverde', 'active'),
  ('22222222-2222-2222-2222-222222222206', 'pedaladventure', 'Pedal Adventure', '/src/assets/partner-guide.jpg', 'partner', 'São Paulo, SP', 4.5, 78, true, 'Aluguel de mountain bikes e e-bikes com capacete e kit de reparo. Rotas sugeridas via app próprio.', 'Aluguel', '+5511999996666', '@pedaladventure', 'active'),
  ('22222222-2222-2222-2222-222222222207', 'saboresdaroca', 'Sabores da Roça', '/src/assets/partner-photographer.jpg', 'partner', 'Ouro Preto, MG', 4.8, 245, true, 'Restaurante familiar com culinária típica mineira. Ingredientes da horta orgânica própria e vista para a serra.', 'Restaurantes', '+5531999997777', '@saboresdaroca', 'active'),
